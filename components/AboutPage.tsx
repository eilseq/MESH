...
export default function AboutPage() {
  return (
    <section
      id="about"
      className="mx-auto w-full max-w-3xl space-y-8 px-6 py-12 text-sm md:text-base overflow-y-scroll scrollbar-custom"
    >
      ...
      <div className="grid gap-8 md:grid-cols-2">
        <div className="space-y-3">
          <h2 className="font-semibold">Why MESH exists</h2>
        ...
        <div className="space-y-3">
          <h2 className="font-semibold">Made for shared experimentation</h2>
          <p className="text-muted-foreground">
      ...
      <div className="rounded-xl border bg-muted/20 p-6 shadow-sm">
        <h2 className="font-semibold">Archive in motion</h2>
        <p className="text-muted-foreground">
